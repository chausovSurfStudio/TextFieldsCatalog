...
````swift
func configure(placeholder: String?, maxLength: Int?, isFloating: Bool = true)
````
...
Присутствуют три варианта поведения:
