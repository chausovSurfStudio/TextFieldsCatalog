...
* Получить новое значение можно с помощью замыкание поля ввода `var onTextChanged: ((BorderedTextField) -> Void)?`

BestPractise по пременению данного типа клавиатуры можно посмотреть в тестовом проекте.
